/*
  ...
  - You are about to drop the column `vectorIDList` on the `Source` table. All the data in the column will be lost.
  - Added the required column `vectorList` to the `Source` table without a default value. This is not possible if the table is not empty.
