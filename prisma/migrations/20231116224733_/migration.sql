/*
  ...
  - You are about to drop the column `filePath` on the `WritingSamples` table. All the data in the column will be lost.
  - Added the required column `fileName` to the `WritingSamples` table without a default value. This is not possible if the table is not empty.
